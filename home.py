...
show_pages(
    [   
        ...
        Page("pages/aboutme.py", "ABOUT CRISTINA LUCERO", "1️⃣", in_section=True),
...
st.markdown("### 👨‍🔧 ML Learning by [Cristina Lucero](https://github.com/Lucerocristina/Lucero/tree/main)")

st.image("./p1.jpg")
st.markdown("""<a href="/photographer/thinkstock-83786">Thinkstock</a> on <a href="/">Freeimages.com</a>""",unsafe_allow_html=True,)

st.info("Visit the project [Github](https://github.com/Lucerocristina/Lucero/tree/main)")
